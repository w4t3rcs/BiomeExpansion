...
public class ForcedWallPlacer : IWallPlacer
{
    ...
    private static void GenerateWallsVertically(int x, int startY, int endY, ushort wall, ushort tileBehindWall = 0, int[] replacedWalls = null)
    {
    ...
    private static void GenerateWallTransition(int y, int leftX, int rightX, ushort wall, ushort tileBehindWall = 0, int[] replacedWalls = null)
    {
    ...
    private static void PlaceWallPoint(int x, int y, ushort wall, ushort tileBehindWall = 0, int[] replacedWalls = null)
    {
