...
public class CorruptionSky : CustomSky
{
    ...
    {
        if (!Main.LocalPlayer.InModBiome<CorruptionInfectedMushroomSurfaceBiome>() || Main.gameMenu) 
            _isActive = false;
    ...
    {
        return Color.Lerp(inColor, new Color(50, 3, 74), _intensity * 0.5f);
    }
    ...
    public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
    {
        ...
        {
            Color skyColor = new Color(50, 3, 74);  // Corruption-like purple
