...
public class CorruptionInfectedBigMushroom : ModTree
{
    ...
    public override void SetStaticDefaults() 
    {
        ...
        _texture = ModContent.Request<Texture2D>("BiomeExpansion/Assets/Tiles/Trees/BigInfectedMushroom");
        _branchesTexture = ModContent.Request<Texture2D>("BiomeExpansion/Assets/Tiles/Trees/BigInfectedMushroomBranches");
        _topsTexture = ModContent.Request<Texture2D>("BiomeExpansion/Assets/Tiles/Trees/BigInfectedMushroomTops");
    }
