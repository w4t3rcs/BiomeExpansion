...
public class CrimsonInfectedMushroomWoodCampfire : ModTile
{
    public override string Texture => TextureHelper.GetDynamicTileTexture("CrimsonInfectedMushroomWoodCampfire");
    ...
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.CrimsonInfectedMushroomWoodCampfire>());
    }
	...
	public override void PostDraw(int i, int j, SpriteBatch spriteBatch) {
		...
		if (tile.TileFrameY < 36) 
			FrameHelper.DrawCampfireFlameEffect(ModContent.Request<Texture2D>("BiomeExpansion/Assets/Tiles/Furniture/CrimsonInfectedMushroomWoodCampfire").Value, i, j);
	}
