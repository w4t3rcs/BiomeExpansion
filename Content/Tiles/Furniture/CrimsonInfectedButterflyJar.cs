...
public class CrimsonInfectedButterflyJar : ModTile
{
    public override string Texture => TextureHelper.DynamicTilesTextures["CrimsonInfectedButterflyJar"];
    ...
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.CrimsonInfectedButterflyJar>());
    }
