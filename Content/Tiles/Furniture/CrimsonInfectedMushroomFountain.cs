...
public class CrimsonInfectedMushroomFountain : ModTile
{
    public override string Texture => TextureHelper.DynamicTilesTextures["CrimsonInfectedMushroomFountain"];
    ...
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.CrimsonInfectedMushroomFountain>());
    }
    ...
    public override void NearbyEffects(int i, int j, bool closer)
    {
        if (!Main.dedServ && Main.tile[i, j].TileFrameX >= 36)
            Main.SceneMetrics.ActiveFountainColor = ModContent.GetInstance<CrimsonInfectedMushroomWaterStyle>().Slot;
    }
        ...
        {
            TileInteractionHelper.MouseOver(ModContent.ItemType<Items.Placeable.Furniture.CrimsonInfectedMushroomFountain>());
        }
}