...
public class CrimsonInfectedDragonflyJar : ModTile
{
    public override string Texture => TextureHelper.DynamicTilesTextures["CrimsonInfectedDragonflyJar"];
    ...
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.CrimsonInfectedDragonflyJar>());
    }
