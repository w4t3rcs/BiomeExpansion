...
public class TestMinion : ModProjectile
{
    ...
    public override void SetStaticDefaults() {
			...
			ProjectileID.Sets.MinionSacrificable[Projectile.type] = true; // This is necessary so your minion can properly spawn when summoned and replaced when other minions are summoned
		...
		public sealed override void SetDefaults() {
			...
			// These below are necessary for a minion weapon
			Projectile.friendly = true; // Only controls if it deals damage to enemies on contact (more on that later)
			Projectile.minion = true; // Declares this as a minion (has many effects)
			Projectile.DamageType = DamageClass.Summon; // Declares the damage type (needed for it to deal damage)
			Projectile.minionSlots = 1f; // The Amount of slots this minion occupies from the total minion slots available to the player (more on that later)
		...
		private void GeneralBehavior(Player owner, out Vector2 vectorToIdlePosition, out float distanceToIdlePosition) {
			...
			// Teleport to player if the distance is too big
